...
class RegistryTests(unittest.TestCase):
    ...
    def test_openai_and_vendor_registered(self):
        self.assertIn("openai-chat", ap.PROVIDERS)
        self.assertIn("vendor-messages", ap.PROVIDERS)
...
class TextExtractionTests(unittest.TestCase):
    ...
    def test_vendor_filters_by_type_text(self):
        blocks = [{"type": "text", "text": "keep"},
                  {"type": "thinking", "text": "drop"}]
        self.assertEqual(ap._text_from_vendor_content(blocks), "keep")
...
class vendorMessagesShapeTests(unittest.TestCase):
