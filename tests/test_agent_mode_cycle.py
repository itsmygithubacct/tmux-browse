...
from lib.agent_modes import cycle as cycle_mode  # noqa: E402


AGENT = {"name": "opus", "model": "assistant-opus-4-7", "wire_api": "vendor-messages"}
...
class CycleRunTests(_IsolatedCycle, unittest.TestCase):
    ...
    def test_two_runs_with_distinct_origins(self):
        with mock.patch("lib.agent_modes.cycle.agent_runner.run_agent",
                        side_effect=_make_runs("1. look around", "done")) as ra, \
             mock.patch("lib.agent_modes.cycle.agent_runtime.record_turn"):
