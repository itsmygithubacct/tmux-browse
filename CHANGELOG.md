...
Follows
`<workspace>/tmux-browse/plans/plan_0.8.0_program.md` + the per-phase
plans under `<workspace>/tmux-browse/plans/plan_mode_*.md` and
...
Three design docs merged under `<workspace>/tmux-browse/plans/`:
...
`<workspace>/tmux-browse/plans/plan_*.md`. Phase A (config-lock
