...
// QR config sharing lives in the tmux-browse-qr extension. It hooks
// ``collectViewConfig`` / ``applyViewConfig`` above via
// ``static/qr.js``. Nothing to do here when that extension is absent.
