...
- Move assistant_code from Visible to Agents → popover closes, pane
  disappears from Visible list, appears under Agents.
- Move assistant_code from Agents to Hidden via Move menu → same effect
  as clicking Hide.
- "+ New group" from the popover: type "Staging", assistant_code lands in
